...
class SignUpViewController: UIViewController {
    ...
    @IBAction func signUpButton(_ sender: Any) {
        if (checkTextField() && emailCheck()) {
            ...
            apiCall(classNumber: signUpClassNumber.text!, email: signUpEmail.text!, name: signUpName.text!, password: signUpPassword.text!)
        } else {
            if !(checkTextField()) {
    ...
    func apiCall(classNumber: String, email: String, name: String, password: String){
        ...
        AF.request(URL, method: .post, parameters: PARAM, encoding: JSONEncoding.default).responseJSON { (respones) in
